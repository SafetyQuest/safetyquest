...
export default function TrueFalseGame({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      {/* Collapsible Explanation (Lesson mode only, after submission) */}
      {!isQuiz && isSubmitted && showFeedback && config.explanation && (
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-4 rounded-lg bg-blue-50 hover:bg-blue-100 border-2 border-blue-200 transition-all"
          >
          ...
          <AnimatePresence>
            {showExplanation && (
              ...
              >
                <div className="p-6 bg-white border-2 border-t-0 border-blue-200 rounded-b-lg">
